...
This folder contains small evidence files pulled from the final MongoDB output.

- `screenshots/` contains MongoDB Atlas screenshots showing example queries and their returned results.
- `samples/` contains the matching exported JSON results.
